...
export default function OverseasHealthCover() {
    return (
        <>
            <NavbarSmallDark />
                ...
                <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center h-full py-20">
                    ...
                    <div className="md:px-4">
                        <div className="space-y-6">
                            ...
                            <p className="text-gray-600 leading-relaxed">
                                We provide comprehensive overseas health cover services to ensure that individuals and families have access to quality healthcare while living or traveling abroad. Our plans are designed to meet the unique needs of expatriates, students, and travelers, offering peace of mind and financial protection in case of medical emergencies.
                            </p>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="col-span-2">
                            <Image
                                src="/images/ilustrations/health-cover.png"
