...
export default function EducationConsultant() {
    return (
        <>
                ...
                <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center h-full py-20">
                    ...
                    <div className="md:px-4">
                        <div className="space-y-6">
                            <p className="text-sm font-medium text-primary-500 uppercase tracking-wide">
                                Our Services
                            </p>
                            ...
                            <p className="text-gray-600 leading-relaxed">
                                We offer personalized <span className="font-bold">guidance in talent mapping, career pathway planning, and course selection</span>  to help individuals discover their strengths and align their academic choices with long-term goals. Our expert consultants work closely with clients to design clear, achievable plans for future success.
                            </p>
                            <p className="text-gray-600 leading-relaxed mt-10">
                                From university or college admissions support to pre-departure and post-arrival services, <span className="font-bold">we provide end-to-end assistance for students pursuing education locally or abroad.</span> We ensure every step of the journey is smooth and informed, from choosing the right institution to settling into a new environment.
                            </p>
                            <p className="text-gray-600 leading-relaxed mt-10">
            ...
            {/* <div className="z-0 bg-gradient-to-b from-white to-gray-200 h-20"></div> */}
