...
const FAQ = () => {
    const faqs = [
        ...
        { question: "How how you deferrent?", answer: "Interlace Studies We believe students should focus more on career development than selecting an educational institution. A solid career plan develops a pathway to reach the destination you want to reach. After the development of a solid career path, then comes the selection of the institutions." },
